export default function OperatorOrderTile(){
    return (



<div className="mt-5 ml-4 mr-4 p-6  border border-gray-300 rounded-md rounded-base shadow-xsm hover:shadow-md transition-shadow duration-300">
